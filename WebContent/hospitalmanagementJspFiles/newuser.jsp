...
<%@ page language="java" import="garima.hospital.management.Logic.*" %>
<jsp:directive.page import="garima.hospital.management.struts.form.HospitalManagementForm"/>
...
<html:html locale="true">
  ...
  <html:form action="/hospitalManagementAction.do?do=newuser">
      		<%
  ...
  <tr><td width="600" height="50px">
  	<b style=""><span style='font-size: 20pt; font-family: "Times New Roman"; color: rgb(74, 21, 117);'>Garima HOSPITAL</span></b><b style=""><span style='font-size: 20pt; font-family: "Times New Roman"; color: rgb(74, 21, 117);'></span></b>
  	</td><td>
   	<img src="../images/img1.jpg" alt="Garima HOSPITAL">
   	</td>
  </table> </td></tr>
    <tr ><td > 
    ...
    <table align="center">
    	...
    	<tr><td></td><td><b><font color="green"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <%=hospitalManagementLogic.id1()%>  </font></b>    </td></tr>
  ...
  <%
  HospitalManagementForm hospitalManagementForm=new HospitalManagementForm();
  hospitalManagementForm.setConsultinghours(hospitalManagementLogic.id2());
   %>
    </html:form>
  </body>
</html:html>
