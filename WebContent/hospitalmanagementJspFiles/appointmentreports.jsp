...
<%@ page language="java" import="garima.hospital.management.HibernamtePackage.*, garima.hospital.management.Logic.*, java.util.* " %>
...
<html:html locale="true">
  ...
  <body>
    <html:form action="/hospitalManagementAction.do?do=appointmentreports1">
  <center>
  ...
  HospitalManagementLogic hospitalManagementLogic=new HospitalManagementLogic();
    List list=hospitalManagementLogic.readDoctor();
    Employees employees;
    int j=0;
     %>
