...
<html> 
	<head>
		<title>JSP for HospitalManagementForm form</title>
	</head>
	<body>
		<html:form action="/hospitalManagementAction.do?do=admin11">
		...
		<tr><td colspan="2" align="center">
			<bean:write property="errorMessage" name="hospitalManagementForm" filter="false"/></td></tr>
		<tr><td><br>
